...
export function parseErApiRates(payload: JsonValue): Record<string, number> {
...
export function parseExchangeRateApiRates(payload: JsonValue): Record<string, number> {
